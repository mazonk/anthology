...
onMounted(() => {
  ...
  gsap.to('.home-view', { opacity: 1, duration: 0.5, ease: 'power2.inOut' });
  animateText();
});

function animateText() {
  gsap.from(".lorem-ipsum > p", {
    opacity: 0,
    y: 20,
    duration: 1,
    stagger: 0.5, // Adjust stagger to control the delay between each line
    ease: "power4.out"
  });
}
